        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition-colors duration-300 font-medium shadow-md hover:shadow-lg"
            >
              Continue Shopping
            </button>
          </div>
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <button
            className="bg-red-500 w-full text-white py-4 px-4 rounded-xl hover:bg-red-600 transition-colors duration-300 text-lg shadow-md hover:shadow-lg mb-5"
